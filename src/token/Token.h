...
const string TOKEN_TYPE_TEXT[] = {
  "OUTPUT",            "UNKNOWN",    "INTEGER", "IDENTIFIER",
  "STRING",            "ASSIGN",     "ADD",     "SUB",
  "SEMICOLON",         "MULT",       "DIVIDE",  "OPEN_PARENTHESYS",
  "CLOSE_PARENTHESYS", "EQUAL_TO",   "SPACE",   "NEW_LINE",
  "IF",                "END",        "SPAWN",   "READ_LINE",
